...
1. Assign reference: `INC-YYYY-NNN` (e.g., `INC-2026-001`)
2. Add a row to the **Incident Log** table above
3. Create a new section below with full details
4. Follow: `docs/breach-response-runbook.md`
...
*Retained 20 years per Digital Health Act 2023.*
